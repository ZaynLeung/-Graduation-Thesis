...
\begin{figure}[t]
  ...
  \caption{Illustration of different motion retargeting methods. (a) Optimization-based method; (b) Learing-based method; 
  (c) Method combining optimization and learning;
  (d) Ours.}
...
现有的动捕数据均已能达到较高帧率\cite{}，而连续多帧信息中蕴含的运动趋势特征对于生成平滑、自然的机器人动作序列至关重要。
